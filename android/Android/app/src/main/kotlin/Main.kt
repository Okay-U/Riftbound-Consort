...
internal val logger: SkipLogger = SkipLogger(subsystem = "riftcount.module", category = "Riftcount")

private typealias AppRootView = RiftcountRootView
private typealias AppDelegate = RiftcountAppDelegate
