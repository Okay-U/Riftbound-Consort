...
//
//  Compact opponent scouting line for the live "Your match" card: the opponent's
//  eloshowdown tier crest + current ELO + their last 3 results. Resolved from the
//  opponent's Riftbound id (the Locator user id on the pairing) via eloshowdown
//  lookup. Renders nothing until data loads, and nothing at all if the opponent
//  has no eloshowdown profile.
//
